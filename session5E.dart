...
void sortCostfor2(List<Restaurant> restaurants,num)
  ...
  // we will sort by using higher order function
...
void main()
{
  ...
  restaurants.forEach((restaurant) => restaurant.displayRestaurant());
  // sort using sort function
  print("After sorting on the basis of discount \n");
  restaurants.sort((R1,R2) => R1.discountPercent.compareTo(R2.discountPercent));
  restaurants.forEach((restaurant)=> restaurant.displayRestaurant());
}
